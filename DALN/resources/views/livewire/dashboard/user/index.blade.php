<div>
    <h1 class="text-gray-800 text-3xl font-black capitalize after:content-[''] after:block after:w-10 after:h-1 after:bg-gray-800 after:rounded-full">{{ __('common.welcome') }}</h1>
    <div class="mt-8 grid md:grid-cols-3 sm:grid-cols-2 grid-cols-1 gap-4">
        <h2 class="sr-only">{{ __('common.statistic') }}</h2>
        <div class="py-4 px-6 bg-gray-50 rounded-tr-xl rounded-bl-xl">
            <div class="flex items-center gap-4">
                ...
                <div class="flex flex-col">
                    <span class="text-gray-600 text-lg">{{ __('room.reservation') }}</span>
        ...
        <div class="py-4 px-6 bg-gray-50 rounded-tr-xl rounded-bl-xl">
            <div class="flex items-center gap-4">
                ...
                <div class="flex flex-col">
                    <span class="text-gray-600 text-lg">{{ __('facility.facility_reviews') }}</span>
        ...
        <div class="py-4 px-6 bg-gray-50 rounded-tr-xl rounded-bl-xl">
            <div class="flex items-center gap-4">
                ...
                <div class="flex flex-col">
                    <span class="text-gray-600 text-lg">{{ __('room.room_reviews') }}</span>

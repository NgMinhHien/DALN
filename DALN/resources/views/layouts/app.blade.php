            ...
            <aside x-show="sidebar" x-on:click.outside="sidebar = (window.innerWidth >= 1024) ? true : false" x-transition.duration.300ms class="lg:w-[400px] w-[300px] max-w-full px-8 overflow-y-auto py-4 mt-14 lg:static absolute inset-y-0 bg-white">
                <div class="space-y-6">
                    @if (auth()->user()->hasRole('user'))
                        <div class="space-y-2">
                            <span class="font['poppins'] uppercase tracking-widest text-gray-400 font-bold px-6 text-sm">{{ __('common.user') }}</span>
                            <div class="grid gap-2">
                                <a href="{{ route('dashboard.user.index') }}" class="{{ !Route::currentRouteNamed('dashboard.user.index') ? 'hover:bg-gray-100' : 'bg-gray-100' }} py-4 px-6 rounded-tr-xl rounded-bl-xl flex items-center gap-2 transition-all duration-300 group">
                                    ...
                                    <span class="font-semibold {{ !Route::currentRouteNamed('dashboard.user.index') ? 'text-gray-400 group-hover:text-gray-600' : 'text-gray-800' }} transition-all duration-300">{{ __('common.dashboard') }}</span>
                                </a>
                            </div>
                            <div class="grid gap-2">
                                <a href="{{ route('dashboard.user.reservations.index') }}" class="{{ !Route::currentRouteNamed('dashboard.user.reservations.*') ? 'hover:bg-gray-100' : 'bg-gray-100' }} py-4 px-6 rounded-tr-xl rounded-bl-xl flex items-center gap-2 transition-all duration-300 group">
                                    ...
                                    <span class="font-semibold {{ !Route::currentRouteNamed('dashboard.user.reservations.*') ? 'text-gray-400 group-hover:text-gray-600' : 'text-gray-800' }} transition-all duration-300">{{ __('room.reservation') }}</span>
                                </a>
                            </div>
                            <div class="grid gap-2">
                                <a href="{{ route('dashboard.user.reviews.rooms.index') }}" class="{{ !Route::currentRouteNamed('dashboard.user.reviews.rooms.*') ? 'hover:bg-gray-100' : 'bg-gray-100' }} py-4 px-6 rounded-tr-xl rounded-bl-xl flex items-center gap-2 transition-all duration-300 group">
                                    ...
                                    <span class="font-semibold {{ !Route::currentRouteNamed('dashboard.user.reviews.rooms.*') ? 'text-gray-400 group-hover:text-gray-600' : 'text-gray-800' }} transition-all duration-300">{{ __('room.room_reviews') }}</span>
                                </a>
                            </div>
                            <div class="grid gap-2">
                                <a href="{{ route('dashboard.user.reviews.facilities.index') }}" class="{{ !Route::currentRouteNamed('dashboard.user.reviews.facilities.*') ? 'hover:bg-gray-100' : 'bg-gray-100' }} py-4 px-6 rounded-tr-xl rounded-bl-xl flex items-center gap-2 transition-all duration-300 group">
                                    ...
                                    <span class="font-semibold {{ !Route::currentRouteNamed('dashboard.user.reviews.facilities.*') ? 'text-gray-400 group-hover:text-gray-600' : 'text-gray-800' }} transition-all duration-300">{{ __('facility.facility_reviews') }}</span>
                                </a>
                            </div>
                        </div>
                    @endif
                    @if (auth()->user()->hasRole('admin'))
                        <div class="space-y-2">
                            <span class="font['poppins'] uppercase tracking-widest text-gray-400 font-bold px-6 text-sm">{{ __('common.admin') }}</span>
                            <div class="grid gap-2">
                                <a href="{{ route('dashboard.admin.index') }}" class="{{ !Route::currentRouteNamed('dashboard.admin.index') ? 'hover:bg-gray-100' : 'bg-gray-100' }} py-4 px-6 rounded-tr-xl rounded-bl-xl flex items-center gap-2 transition-all duration-300 group">
                                    ...
                                    <span class="font-semibold {{ !Route::currentRouteNamed('dashboard.admin.index') ? 'text-gray-400 group-hover:text-gray-600' : 'text-gray-800' }} transition-all duration-300">{{ __('common.dashboard') }}</span>
                                </a>
                            </div>
                            <div class="grid gap-2">
                                <a href="{{ route('dashboard.admin.rooms.index') }}" class="{{ !Route::currentRouteNamed('dashboard.admin.rooms.*') ? 'hover:bg-gray-100' : 'bg-gray-100' }} py-4 px-6 rounded-tr-xl rounded-bl-xl flex items-center gap-2 transition-all duration-300 group">
                                    ...
                                    <span class="font-semibold {{ !Route::currentRouteNamed('dashboard.admin.rooms.*') ? 'text-gray-400 group-hover:text-gray-600' : 'text-gray-800' }} transition-all duration-300">{{ __('common.rooms') }}</span>
                                </a>
                            </div>
                            <div class="grid gap-2">
                                <a href="{{ route('dashboard.admin.facilities.index') }}" class="{{ !Route::currentRouteNamed('dashboard.admin.facilities.*') ? 'hover:bg-gray-100' : 'bg-gray-100' }} py-4 px-6 rounded-tr-xl rounded-bl-xl flex items-center gap-2 transition-all duration-300 group">
                                    ...
                                    <span class="font-semibold {{ !Route::currentRouteNamed('dashboard.admin.facilities.*') ? 'text-gray-400 group-hover:text-gray-600' : 'text-gray-800' }} transition-all duration-300">{{ __('common.facilities') }}</span>
                                </a>
                            </div>
                            <div class="grid gap-2">
                                <a href="{{ route('dashboard.admin.galeries') }}" class="{{ !Route::currentRouteNamed('dashboard.admin.galeries') ? 'hover:bg-gray-100' : 'bg-gray-100' }} py-4 px-6 rounded-tr-xl rounded-bl-xl flex items-center gap-2 transition-all duration-300 group">
                                    ...
                                    <span class="font-semibold {{ !Route::currentRouteNamed('dashboard.admin.galeries') ? 'text-gray-400 group-hover:text-gray-600' : 'text-gray-800' }} transition-all duration-300">{{ __('common.gallery') }}</span>
                                </a>
                            </div>
                            <div class="grid gap-2">
                                <a href="{{ route('dashboard.admin.users.index') }}" class="{{ !Route::currentRouteNamed('dashboard.admin.users.*') ? 'hover:bg-gray-100' : 'bg-gray-100' }} py-4 px-6 rounded-tr-xl rounded-bl-xl flex items-center gap-2 transition-all duration-300 group">
                                    ...
                                    <span class="font-semibold {{ !Route::currentRouteNamed('dashboard.admin.users.*') ? 'text-gray-400 group-hover:text-gray-600' : 'text-gray-800' }} transition-all duration-300">{{ __('common.users') }}</span>
                                </a>
                            </div>
                        </div>
                    @endif
                    @if (auth()->user()->hasRole('receptionist'))
                        <div class="space-y-2">
                            <span class="font['poppins'] uppercase tracking-widest text-gray-400 font-bold px-6 text-sm">{{ __('common.receptionist') }}</span>
                            <div class="grid gap-2">
                                <a href="{{ route('dashboard.receptionist.index') }}" class="{{ !Route::currentRouteNamed('dashboard.receptionist.index') ? 'hover:bg-gray-100' : 'bg-gray-100' }} py-4 px-6 rounded-tr-xl rounded-bl-xl flex items-center gap-2 transition-all duration-300 group">
                                    ...
                                    <span class="font-semibold {{ !Route::currentRouteNamed('dashboard.receptionist.index') ? 'text-gray-400 group-hover:text-gray-600' : 'text-gray-800' }} transition-all duration-300">{{ __('common.dashboard') }}</span>
                                </a>
                            </div>
                            <div class="grid gap-2">
                                <a href="{{ route('dashboard.receptionist.reservations.index') }}" class="{{ !Route::currentRouteNamed('dashboard.receptionist.reservations.*') ? 'hover:bg-gray-100' : 'bg-gray-100' }} py-4 px-6 rounded-tr-xl rounded-bl-xl flex items-center gap-2 transition-all duration-300 group">
                                    ...
                                    <span class="font-semibold {{ !Route::currentRouteNamed('dashboard.receptionist.reservations.*') ? 'text-gray-400 group-hover:text-gray-600' : 'text-gray-800' }} transition-all duration-300">{{ __('room.reservation') }}</span>
                                </a>
                            </div>
                            <!-- <div class="grid gap-2">
                                <a href="{{ route('dashboard.receptionist.reservations.index') }}" class="{{ !Route::currentRouteNamed('dashboard.receptionist.reservations.*') ? 'hover:bg-gray-100' : 'bg-gray-100' }} py-4 px-6 rounded-tr-xl rounded-bl-xl flex items-center gap-2 transition-all duration-300 group">
                            ...
                            <div class="grid gap-2">
                                <a href="{{ route('dashboard.receptionist.rooms.index') }}" class="{{ !Route::currentRouteNamed('dashboard.receptionist.rooms.*') ? 'hover:bg-gray-100' : 'bg-gray-100' }} py-4 px-6 rounded-tr-xl rounded-bl-xl flex items-center gap-2 transition-all duration-300 group">
                                    ...
                                    <span class="font-semibold {{ !Route::currentRouteNamed('dashboard.receptionist.rooms.*') ? 'text-gray-400 group-hover:text-gray-600' : 'text-gray-800' }} transition-all duration-300">{{ __('room.room_management') }}</span>
                                </a>
                            </div>
                    @endif
                    <div class="space-y-2">
                        <span class="font['poppins'] uppercase tracking-widest text-gray-400 font-bold px-6 text-sm">{{ __('common.account') }}</span>
                        <div class="grid gap-2">
                            <a href="#" class="hover:bg-gray-100 py-4 px-6 rounded-tr-xl rounded-bl-xl flex items-center gap-2 transition-all duration-300 group">
                                ...
                                <span class="font-semibold text-gray-400 group-hover:text-gray-600 transition-all duration-300">{{ __('common.profile') }}</span>
                            </a>
                        </div>
                        <div class="grid gap-2">
                            <a href="#" class="hover:bg-gray-100 py-4 px-6 rounded-tr-xl rounded-bl-xl flex items-center gap-2 transition-all duration-300 group">
                                <i class='bx bx-cog text-xl text-gray-400 group-hover:text-gray-600 transition-all duration-300'></i>
                                <span class="font-semibold text-gray-400 group-hover:text-gray-600 transition-all duration-300">{{ __('common.settings') }}</span>
                            </a>
                        </div>
                        <form method="POST" action="{{ route('logout') }}" class="grid gap-2">
                            ...
                            <a href="{{ route('logout') }}" onclick="event.preventDefault(); this.closest('form').submit();" class="hover:bg-gray-100 py-4 px-6 rounded-tr-xl rounded-bl-xl flex items-center gap-2 transition-all duration-300 group">
                                ...
                                <span class="font-semibold text-gray-400 group-hover:text-gray-600 transition-all duration-300">{{ __('auth.logout') }}</span>
                            </a>
                        </form>
                    </div>
                </div>
